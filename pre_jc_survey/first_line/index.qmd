---
title: "Nivo Plus Ipi Dosing in First-Line MCC"
include-in-header: 
  - text: |
      <style>
        body {
...
#| fig-height: 6
#| fig-align: center
source(file.path(scripts_dir, "Question10_first_line_dosing.R"))

dosing_plot
```

<div style="text-align: right; margin-top: 2rem;">
  <a href="../labeling_warranted/" class="btn btn-primary">← Previous</a>
  <a href="../second_line/" class="btn btn-primary">Next →</a>
</div>
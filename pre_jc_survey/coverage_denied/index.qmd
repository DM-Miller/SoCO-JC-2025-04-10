---
title: "Coverage for Ipi/Nivo in MCC"
include-in-header: 
  - text: |
      <style>
        body {
...
#| fig-height: 6
#| fig-align: center
source(file.path(scripts_dir, "Question6_Coverage.R"))

coverage_ipi_nivo_plot
```

<div style="text-align: right; margin-top: 2rem;">
  <a href="../case_2/" class="btn btn-primary">← Previous</a>
  <a href="../nccn_guidelines/" class="btn btn-primary">Next →</a>
</div>
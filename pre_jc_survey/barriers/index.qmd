...
#| fig-height: 6
#| fig-align: center
source(file.path(scripts_dir, "Question12_Barriers.R"))

barriers_ipi_nivo_plot
```

<div style="text-align: right; margin-top: 2rem;">
  <a href="../dosing/" class="btn btn-primary">← Previous</a>
  <a href="https://dm-miller.github.io/SoCO-Journal-Club/article.html" class="btn btn-primary">Next →</a>
</div>

...
question_var <- "ipi_nivo_dosing_2l"
title_string <- "If you were to use Nivo plus Ipi in the second-line setting, what dosing would you use?"
...
# Plot
dosing_plot <- ggplot(plot_data, aes(x = .data[[question_var]], y = n)) +
